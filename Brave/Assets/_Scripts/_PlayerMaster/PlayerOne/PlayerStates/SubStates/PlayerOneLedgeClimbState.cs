...
public class PlayerOneLedgeClimbState : PlayerOneState
{
    ...
    public PlayerOneLedgeClimbState(PlayerOne player, PlayerOneStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
