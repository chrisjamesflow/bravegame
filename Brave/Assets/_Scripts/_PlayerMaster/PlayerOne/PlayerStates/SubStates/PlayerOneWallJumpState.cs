...
public class PlayerOneWallJumpState : PlayerOneAbilityState
{
    private int wallJumpDirection;

    public PlayerOneWallJumpState(PlayerOne player, PlayerOneStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
