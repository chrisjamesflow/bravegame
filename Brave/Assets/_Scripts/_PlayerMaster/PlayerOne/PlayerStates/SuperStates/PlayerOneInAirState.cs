...
public class PlayerOneInAirState : PlayerOneState
{
    //Input
    ...
    public PlayerOneInAirState(PlayerOne player, PlayerOneStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
