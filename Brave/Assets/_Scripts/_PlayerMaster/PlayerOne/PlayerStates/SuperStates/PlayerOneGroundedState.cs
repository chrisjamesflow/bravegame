...
public class PlayerOneGroundedState : PlayerOneState
{
    ...
    public PlayerOneGroundedState(PlayerOne player, PlayerOneStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
