...
public class PlayerThreeLedgeClimbState : PlayerThreeState
{
    ...
    public PlayerThreeLedgeClimbState(PlayerThree player, PlayerThreeStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
