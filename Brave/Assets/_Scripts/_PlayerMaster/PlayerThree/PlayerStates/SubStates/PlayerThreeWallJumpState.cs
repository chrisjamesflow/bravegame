...
public class PlayerThreeWallJumpState : PlayerThreeAbilityState
{
    private int wallJumpDirection;

    public PlayerThreeWallJumpState(PlayerThree player, PlayerThreeStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
