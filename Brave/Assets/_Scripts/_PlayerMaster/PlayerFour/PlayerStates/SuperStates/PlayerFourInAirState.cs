...
public class PlayerFourInAirState : PlayerFourState
{
    //Input
    ...
    public PlayerFourInAirState(PlayerFour player, PlayerFourStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
