...
public class PlayerFourWallJumpState : PlayerFourAbilityState
{
    private int wallJumpDirection;

    public PlayerFourWallJumpState(PlayerFour player, PlayerFourStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
