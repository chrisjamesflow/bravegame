...
public class PlayerFourLedgeClimbState : PlayerFourState
{
    ...
    public PlayerFourLedgeClimbState(PlayerFour player, PlayerFourStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
    ...
    public override void Exit()
    {
        ...
        if (isClimbing && !isTouchingCeiling)
        {
