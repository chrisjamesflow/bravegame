...
public class PlayerFiveGroundedState : PlayerFiveState
{
    ...
    public PlayerFiveGroundedState(PlayerFive player, PlayerFiveStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
