...
public class PlayerFiveInAirState : PlayerFiveState
{
    //Input
    ...
    public PlayerFiveInAirState(PlayerFive player, PlayerFiveStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
