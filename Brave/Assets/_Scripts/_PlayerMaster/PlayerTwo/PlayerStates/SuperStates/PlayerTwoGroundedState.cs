...
public class PlayerTwoGroundedState : PlayerTwoState
{
    ...
    public PlayerTwoGroundedState(PlayerTwo player, PlayerTwoStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
