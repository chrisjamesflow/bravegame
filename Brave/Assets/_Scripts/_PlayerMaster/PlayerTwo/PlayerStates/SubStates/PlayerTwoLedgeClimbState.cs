...
public class PlayerTwoLedgeClimbState : PlayerTwoState
{
    ...
    public PlayerTwoLedgeClimbState(PlayerTwo player, PlayerTwoStateMachine stateMachine, PlayerData playerData, string animBoolName) : base(player, stateMachine, playerData, animBoolName)
    {
    }
