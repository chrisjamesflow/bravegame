...
public class Wolf_JumpDownState : JumpDownState
{
    ...
    public Wolf_JumpDownState(Entity entity, FiniteStateMachine stateMachine, string animBoolName, D_JumpDownState stateData, Wolf enemy) : base(entity, stateMachine, animBoolName, stateData)
    {
        this.enemy = enemy;
    }
