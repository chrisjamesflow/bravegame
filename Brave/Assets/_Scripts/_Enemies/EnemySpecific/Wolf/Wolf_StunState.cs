...
public class Wolf_StunState : StunState
{
    ...
    public override void LogicUpdate()
    {
        ...
        if (isStunTimeOver)
        {
            if(performCloseRangeActionLow || performCloseRangeActionMid || performCloseRangeActionHigh)
            {
                stateMachine.ChangeState(enemy.meleeAttackState);
            }
            else if(isPlayerInLowAgroRange || isPlayerInMidAgroRange || isPlayerInHighAgroRange)
            {
